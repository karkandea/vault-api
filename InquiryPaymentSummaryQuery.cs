namespace APS_Common.Const.Queries.StoredProcedures
{
    public static class InquiryPaymentSummaryQuery 
    { 
        public const string GetInquiryPaymentSummaryQuery = $@"
USE [AMFS_APS_BVT_TRIAL]
GO
/****** Object:  StoredProcedure [dbo].[usp_GetInquiryPaymentSummary]    Script Date: 12/11/2025 8:36:23 AM ******/
SET ANSI_NULLS ON
GO
...
---- =============================================
--EXEC usp_GetInquiryPaymentSummary 0,0,'','','3405 NON SHOPPING CART 20251029','','','','','','','','','','','','','','','','','',1,'RequestNumber','DESC'
...
ALTER PROCEDURE [dbo].[usp_GetInquiryPaymentSummary] 
	...
	@PaymentDateFrom VARCHAR(100) = null,
	@PaymentDateTo VARCHAR(100) = null,
...
BEGIN
	...
	--@Page int = 0,
	--@PageSize int = 10,
	--@RequestType VARCHAR(100) = 'cash advance travel',
	--@RequestNumber VARCHAR(100) = 'CATR2025012800001',
	--@VoucherNumber VARCHAR(100) = '',
	--@VoucherId VARCHAR(100) = '',
	--@TransferNumber VARCHAR(100) = '',
	--@VendorCategoryId VARCHAR(100) = '',
	...
	--@CutOffHour VARCHAR(100) = '15:00:00',
	--@IsExport bit = 1,
	--@SortColumn VARCHAR(100) = 'DESC',
	--@SortDirection VARCHAR(100) = 'TransferDate'
	...
	IF (@RequestType = 'purchase order' OR @RequestType = '' OR @RequestType IS NULL)
	BEGIN
